    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <el-table
          stripe
          :data="pageOfItems"
          :default-sort="{prop: 'codigo', order: 'descending'}"
          style="width: 100%"
        >
          <el-table-column align="center" prop="nombre" label="Nombre" width="350" sortable></el-table-column>
          <el-table-column align="center" prop="nit" label="Nit" width="120" sortable></el-table-column>
          <el-table-column align="center" type="expand" label="Contacto" width="120">
            <template slot-scope="props">
              <p>Direccion: {{ props.row.direccion }}</p>
              <p>Telefono: {{ props.row.telefono }}</p>
              <p>Responsable: {{ props.row.responsable }}</p>
            </template>
          </el-table-column>
          <el-table-column align="center" prop="rubro" label="Rubro" width="300" sortable></el-table-column>
          <el-table-column label="Operacion">
            <template slot-scope="scope">
              ...
              <router-link
                ...
                :to="{ name: 'editproveedor',params:{id:scope.row.idProveedor } }"
              >
...
export default {
  ...
  methods: {
    ...
    OnClickDelete(index, row) {
      this.$confirm(
        `¿ Esta seguro que desea eliminar al proveedor ${row.nombre} ?`,
        "Advertencia",
        {
  ...
  created() {
    this.$store.dispatch("proveedor/getItems");
  }
};
</script>
<style>
