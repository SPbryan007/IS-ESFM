    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        >
          ...
          <el-form-item>
            <el-button type="primary" :loading="loading_form" @click="submitForm('UnidadAddForm')">
              Registar
              <i class="fas fa-save"></i>
            </el-button>
            <el-button @click="cancelForm('UnidadAddForm')">Cancelar</el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
