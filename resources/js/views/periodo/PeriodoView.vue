                    ...
                    <div class="col-md-6 mb-1">
                        <ol class="breadcrumb float-sm-left">
                            <el-breadcrumb separator-class="el-icon-arrow-right">
                                <el-breadcrumb-item :to="{ path: '/periodo' }">Periodo contable</el-breadcrumb-item>
                                <el-breadcrumb-item v-if="this.$route.name == 'addperiodo'">Registrar</el-breadcrumb-item>
        ...
        <section class="content">
            ...
            <div class="container">
                <transition name="fade" mode="out-in">
                    <keep-alive>
                        <router-view name="ViewRouterPeriodo"></router-view>
                    </keep-alive>
                </transition>
