        ...
        >
          ...
          <el-table-column type="expand">
            <template slot-scope="props">
              ...
              <p>Cargo: {{ props.row.cargo }}</p>
            </template>
          </el-table-column>
          <el-table-column prop="nombre" label="Nombre" width="220" sortable></el-table-column>
          <el-table-column prop="apellido" label="Apellido" width="220" sortable></el-table-column>
          ...
          >
            <template slot-scope="scope">
              <el-tag type="warning" disable-transitions>
                <strong>{{scope.row.unidad_nombre}}</strong>
              </el-tag>
            </template>
          </el-table-column>
          <el-table-column label="Operacion">
            <template slot-scope="scope">
              ...
              <router-link
                ...
                :to="{ name: 'editsolicitante',params:{id:scope.row.idSolicitante } }"
              >
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("solicitante", ["GET_FILTER_ITEMS"]),
