...
const mutations = {
    ...
    [types.SET_EDIT_FORM]: (state, item) => {
        ...
        state.data_form.nit         = item.nit;
        state.data_form.rubro       = item.rubro;
        state.data_form.telefono    = item.telefono;
        state.data_form.direccion   = item.direccion;
        state.data_form.responsable = item.responsable;
    },
