...
class UnidadMedidaController extends Controller
{
    ...
    /**
     * UnidadMedidaController constructor.
    ...
    {
        try {
            $partidas = $this->unidadMedidaRepository->getAll($request->query('withTrashed'));
    ...
    public function create(Request $request)
    {
        ...
        try {
            $ola = $this->unidadMedidaRepository->register($request);
            return response()->json(['message' => 'La unidad de medida se ha registrado con éxito.'.$ola],201);
        }catch (QueryException $e){
            $errorCode = $e->errorInfo[1];
            if($errorCode == 1062){
                return response()->json(['message' => 'La sigla ya se encuentra registrada.'],409);
            }
        }catch (\Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try{
            $this->unidadMedidaRepository->update($id,$request);
    ...
    {
        try {
            $status = $this->unidadMedidaRepository->setStatus($id);
