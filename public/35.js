...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread({
    OnclickAddDialog: function OnclickAddDialog(index, row) {
      _store_index__WEBPACK_IMPORTED_MODULE_2__["default"].commit("ingreso/ADD_DETALLE_INGRESO", row);
    }
  }, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapMutations"])("ingreso", ["DELETE_DETALLE_INGRESO"]), {
    findItem: function findItem(id) {
      var items = _store_index__WEBPACK_IMPORTED_MODULE_2__["default"].getters["articulo/GET_ITEMS_ARTICULO"];
    ...
    onRegister: function onRegister() {
      ...
      this.$confirm("\xBF Esta seguro de registrar el ingreso ?", {
        ...
        _store_index__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch("ingreso/addItem", {
  ...
  mounted: function mounted() {
    _store_index__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch("articulo/getItems");
    _store_index__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch("articulo/getLotes");
  }
});
