                                    ...
                                    _c(
                                      ...
                                      _vm._l(
                                        [
                                          ...
                                          {
                                            key: "LP-AN",
                                            value: "Licitancion publica de ANPE"
                                          },
                                          {
                                            key: "LI-PU",
                                            value: "Licitancion publica"
                                          }
                                        ],
                                        function(item, index) {
                                          return _c("el-option", {
                              ...
                              _c(
                                ...
                                [
                                  _c("el-input", {
                                    staticStyle: { width: "170px" },
                                    model: {
                                      value: _vm.data_form.acta,
                                      callback: function($$v) {
                                        _vm.$set(_vm.data_form, "acta", $$v)
                                      },
                                      expression: "data_form.acta"
                                    }
                                  })
                                ],
                                1
                                ...
                                [
                                  _c("el-date-picker", {
                                    ...
                                    model: {
                                      ...
                                      expression: "data_form.fecha_comprobante"
                                    }
                                  })
                                ],
                                1
