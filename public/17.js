...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    Print: function Print() {
      ...
      window.open('http://localhost:8000/controller/reportes/saldos_almacen_print?periodo=' + this.consulta.periodo + '&del=' + this.consulta.del + '&al=' + this.consulta.al + '&formato=' + this.consulta.formato, '_blank');
    },
