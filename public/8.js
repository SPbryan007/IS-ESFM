          ...
          [
            ...
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { prop: "codigo", label: "Código", sortable: "" }
                }),
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { prop: "nombre", label: "Nombre", sortable: "" }
                }),
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { prop: "linea", label: "Linea", sortable: "" }
                }),
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { prop: "deleted_at", label: "Estado", sortable: "" },
                  scopedSlots: _vm._u([
                    {
                      key: "default",
                      fn: function(scope) {
